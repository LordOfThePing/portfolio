...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    // Renderer with DPR for crispness
    ...
    // Mouse move: listen on window so hover works over the whole page
    ...
    for (let i = 0; i < count; i++) {
      // Random point inside unit sphere (radius bias for uniform volume)
    ...
    return () => {
      ...
      // Let GC reclaim WebGL resources
    };
  }, [
    particleCount,
    particleSpread,
